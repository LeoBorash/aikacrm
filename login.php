...
if (!isset($_SESSION['user_login'])) {
    if (isset($_POST['login'])) {
        ...
        user_login = '$_POST[user_login]' AND
		...
		c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z"/>
                        ...
                        <div class="single-item">
                            <div>
                                <div>
                                    <h3>Томас Эдисон</h3>
                                    <p>«Біздің ең үлкен әлсіздігіміз - бас тарту. Табысқа жетудің сенімді әдісі - қайталап көру».</p>
                                </div>
                            </div>
                            <div>
                                <div>
                                    <h3>Роберт Кийосаки</h3>
                                    <p>Басқалар байқамағанды көре білу жетістікке жетудің негізгі кілті. </p>
                                </div>
                            ...
                            <div>
                                <div>
                                    <h3>Тони Роббинс</h3>
                                    <p> "Если вы делаете то, что делали всегда, вы получаете то, что получали всегда. "</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card tab2-card">
                        <div class="card-body">
                            <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="top-profile-tab" data-toggle="tab" href="#top-profile" role="tab" aria-controls="top-profile" aria-selected="true"><span class="icon-user mr-2"></span>Авторизация</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="contact-top-tab" data-toggle="tab" href="#top-contact" role="tab" aria-controls="top-contact" aria-selected="false"><span class="icon-unlock mr-2"></span>Регистрация</a>
                                </li>
                            </ul>
                            <div class="tab-content" id="top-tabContent">
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                    <form action="" method="post" class="form-horizontal auth-form">
                                        <div class="form-group">
                                            <input required="" name="user_login" type="text" class="form-control" placeholder="Логин" id="exampleInputEmail1">
                                        </div>
                                        <div class="form-group">
                                            <input required="" name="user_pass" type="password" class="form-control" placeholder="Пароль">
                                        </div>
                                        <div class="form-terms">
                                            <div class="custom-control custom-checkbox mr-sm-2">
                                                <input type="checkbox" class="custom-control-input" id="customControlAutosizing">
                                                <a href="#" class="btn btn-default forgot-pass">Забыли пароль?</a>
                                            </div>
                                        </div>
                                        <div class="form-button">
                                            <button class="btn btn-info w-50" name="login" style="border-radius: 25px" type="submit">Вход</button>
                                        </div>
                                    </form>
                                </div>
                                <div class="tab-pane fade" id="top-contact" role="tabpanel" aria-labelledby="contact-top-tab">
                                    <form class="form-horizontal auth-form">
                                        <div class="form-group">
                                            <input required="" name="login[username]" type="email" class="form-control" placeholder="Ф.И.О" id="exampleInputEmail12">
                                        </div>
                                        <div class="form-group">
                                            <input required="" name="login[password]" type="password" class="form-control" placeholder="Пароль">
                                        </div>
                                        <div class="form-group">
                                            <input required="" name="login[password]" type="password" class="form-control" placeholder="Подтвердите пароль">
                                        </div>
                                        <div class="form-button">
                                            <button class="btn btn-info" style="border-radius: 25px" type="submit">Регистрация</button>
                                        </div>
                                    </form>
                                </div>
